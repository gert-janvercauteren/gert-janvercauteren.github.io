...
import ExpandButtonDemo from "./routes/ExpandButtonDemo";
import ListDemo from "./routes/ListDemo";
        ...
        <React.StrictMode>
            <HashRouter>
                <Routes>
                    ...
                    <Route path="/demo/button-demo" element={<ExpandButtonDemo />}/>
                    <Route path="/demo/list" element={<ListDemo />}></Route>
                </Routes>
            </HashRouter>
        </React.StrictMode>
    )
